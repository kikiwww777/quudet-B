...
```powershell
cd D:\
git clone <你的仓库地址> yolo26  \\这是我的：git clone https://gitee.com/yu-shijiao/quudet1.0.git
cd D:\yolo26
```
...
下面是我用的：
export MASTER_API_BASE="http://172.16.10.114:8000"
export NODE_ID="linux-01"
export NODE_NAME="Linux-01"
export NODE_TOKEN="12345678123456781234567812340001"
export YOLO_WORK_DIR="$HOME/yolo26"
```
